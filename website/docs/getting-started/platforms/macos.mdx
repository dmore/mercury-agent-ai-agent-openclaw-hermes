...
| CPU | Asset |
|---|---|
| Apple Silicon (M1/M2/M3/M4) | `mercury-darwin-arm64` |
| Intel | `mercury-darwin-x64` |
...
```bash
curl -fsSL https://mercury.cosmicstack.org/install.sh | MERCURY_VERSION=1.1.9 sh
```

## Custom install location

```bash
curl -fsSL https://mercury.cosmicstack.org/install.sh | \
